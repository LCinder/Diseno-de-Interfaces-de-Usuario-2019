    ...
    INSPIRO.core = {
        ...
        goToTop: function () {
            if ($goToTop.length > 0) {
                ...
                var scrollOffset = $body.attr('data-offset') || 200;
        ...
        pageLoader: function () {
            ...
            if (!$body.hasClass('no-page-loader')) {
                var pageInAnimation = $body.attr('data-animation-in') || "fadeIn",
                    ...
                    pageLoaderIcon = $body.attr('data-icon') || 50,
                    pageLoaderIconColor = $body.attr('data-icon-color') || 50,
                    pageInDuration = $body.attr('data-speed-in') || 2000,
                    pageOutDuration = $body.attr('data-speed-out') || 1000,
                    iconColor = "",
                    loadingInnerHTML = "";
                ...
                switch (Number(pageLoaderIcon)) {
                    default:
                       loadingInnerHTML = '<div class="loader-inner ball-triangle-path"><div></div><div></div><div></div></div>';
                        iconColor = '.ball-triangle-path > div {background: '  + ' !important;}';
                        break;                 
                }
